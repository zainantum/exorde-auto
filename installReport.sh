...
wget https://raw.githubusercontent.com/zainantum/checker/main/sendReport.sh && chmod 777 sendReport.sh && wget https://raw.githubusercontent.com/zainantum/checker/main/sendLog.sh && chmod 777 sendLog.sh
